...
AUTHENTICATE_SCRIPT = """from Products.SQLUserWizard.sessions import authenticate_session
return authenticate_session(context, credentials)
"""

ENUMERATE_USERS_SCRIPT = """from Products.SQLUserWizard.pas import enumerate_users
return enumerate_users(context, id, login, exact_match, sort_by, max_results)
"""

ROLES_SCRIPT = """from Products.SQLUserWizard.pas import roles_for_principal
return roles_for_principal(context, principal)
"""
